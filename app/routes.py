...
@appy.route("/index", methods=["GET", "POST"])
@login_required
def index():
    ...
    posts = current_user.followed_posts().paginate(
        page, appy.config["POSTS_PER_PAGE"], False
    )
...
@appy.route("/reset_password_request", methods=["GET", "POST"])
...
@appy.route("/reset_password/<token>", methods=["GET", "POST"])
...
def resume():
    ...
    return render_template("resume.html", title="Resume", **content)
